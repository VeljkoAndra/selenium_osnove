...
public class Zadatak4 {
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.cssSelector("div.art-control-playAndPause i.art-icon-play")).click();
        driver.findElement(By.cssSelector("div.art-control-volume i.art-icon-volume")).click();
        Thread.sleep(3000);
        ...
        Thread.sleep(1000);
        driver.findElement(By.cssSelector("div.art-control-pip")).click();
        driver.findElement(By.cssSelector("div.art-control-fullscreen")).click();
        driver.findElement(By.cssSelector("div.art-control-fullscreen")).click();
        Thread.sleep(5000);
